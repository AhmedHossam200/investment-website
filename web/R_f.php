...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5">
                    <h1 class="text-center">Sign-up as finance applicant </h1>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                     <input type="tel" name="phone" class="form-control" placeholder="Enter whatsapp number" required>
                     </div>
                                      <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block" name="s_f" value="submit" >
                    </div>
                    </form>
                </div>
