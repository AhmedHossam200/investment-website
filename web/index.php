      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="login_Investor.php">login/sign-up as investor</a>
            </li>
            
            
            <li class="nav-item">
              <a class="nav-link" href="login.php">login/sign-up as finance applicant</a>
            </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 col-sm-12  text-white">
          ...
          <h1>Modern investment</h1>
            <h3>We help small business owners reach the right financiers in the easiest and fastest way</h3>
