        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <div class="dropdown">
                <a href="#" class="nav-link">List of projects</a>
  ...
  <main>
    ...
    <div class="container-fluid">
         <div class="row">
             ...
             $sql = "SELECT * FROM `order` WHERE user_finance_id  = '$id'";
        ...
        $statement = $connection->prepare($sql);
          $statement->execute([]);
            $people = $statement->fetchAll(PDO::FETCH_OBJ);
                 ?>
                 <h3 class="text-center text-info">list of your all projects  </h3>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
                         ...
                         <a  href="delete_project2.php?delete66=<?= $person->id; ?>" class="badge badge-danger p-2">Delete</a>
